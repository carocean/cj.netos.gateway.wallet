...
@CjService(name = "/trade/receipt/ackCancelReceipt.mhub#withdraw")
public class AckCancelReceiptWithdrawCommand implements IConsumerCommand {
    @CjServiceRef
    ...
    public void command(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws RabbitMQException, RetryCommandException, IOException {
        ...
        try {
            withdrawActivityController.ackCancelReceipt(result);
