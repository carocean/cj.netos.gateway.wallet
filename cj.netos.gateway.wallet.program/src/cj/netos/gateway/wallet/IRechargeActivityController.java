...
public interface IRechargeActivityController {
    RechargeRecord doReceipt(String principal, String personName, String currency, long amount, PayChannel payChannel,String applyTerminal,String openid, String note) throws CircuitException;
