...
@CjService(name = "trialBillService")
public class TrialBillService implements ITrialBillService {
    @CjServiceSite
    IServiceSite site;

    @Override
    public List<Object> pageBill(String principal, int limit, long offset) throws CircuitException {
        return call_pageBill(principal, limit, offset);
    }
    private List<Object> call_pageBill(String person, int limit, long offset) throws CircuitException {
        ...
        String portsUrl = site.getProperty("rhub.ports.oc.bill.trial");
    ...
    @Override
    public List<Object> monthBill(String principal, int year, int month, int limit, long offset) throws CircuitException {
        return call_monthBill(principal, year, month, limit, offset);
    }
