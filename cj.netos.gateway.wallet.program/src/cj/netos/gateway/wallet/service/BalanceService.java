...
public class BalanceService implements IBalanceService {
    ...
    @Override
    public Map<String, Object> getTrialAccount(String principal) throws CircuitException {
        return callGetTrialAccount(principal);
    }
    private Map<String, Object> callGetTrialAccount(String person) throws CircuitException {
        OkHttpClient client = (OkHttpClient) site.getService("@.http");
        ...
        final Request request = new Request.Builder()
                .url(String.format("%s?person=%s", portsUrl, person))
                .addHeader("Rest-Command", "getTrialAccount")
                .addHeader("app-id", appid)
                .addHeader("app-key", appKey)
                .addHeader("app-nonce", nonce)
                .addHeader("app-sign", sign)
